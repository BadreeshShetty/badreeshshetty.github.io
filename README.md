...
### Data Engineering Project: ELT using AWS, Airflow, Celery, DBT, Snowflake, Tableau Python, and SQL
[Blog](https://grape-liquid-f37.notion.site/Data-Engineering-NYC-Parking-Violations-d7ab76c922d74d079c347888b62246f3) and 
[Youtube Link](https://www.youtube.com/watch?v=PNe9POTPx4I) and
[GitHub](https://github.com/BadreeshShetty/Data-Engineering-ETL-Airflow-DBT-Parking)
- This project highlights my expertise in Data Engineering through the creation of a resilient ELT pipeline designed to process and analyze a substantial dataset of parking violation data from New York City (~50 million records). Leveraging AWS S3 for cloud storage, Airflow for orchestrating workflows, Celery for distributed task execution, and DBT for effective data transformations, I established a scalable data pipeline. The project integrates Snowflake for data warehousing, Tableau for crafting interactive dashboards, Python for scripting automation, and SQL for proficient database management. I successfully managed and analyzed a large-scale dataset, demonstrating advanced skills in data engineering and analytics. 
  <img width="1470" alt="DE-ELT" src="https://raw.githubusercontent.com/BadreeshShetty/Data-Engineering-ETL-Airflow-DBT-Parking/main/NYParkingViolationsArchitecture.png">
...
### Stadium Analytics Engineering Project (Docker, Airflow, AWS(S3), BeautifulSoup, Snowflake, Tableau, Python & SQL)
